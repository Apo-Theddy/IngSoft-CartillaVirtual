...
function showEditPopUp(...data) {
    ...
    popup.style.display = 'block';
    divEditar.innerHTML = ` <div class="titulopop">Editar</div>
                    <form action="">
                        <p>
    ...
    btnEdit.addEventListener("click", async (event) => {
        ...
        const DishID = parseInt(data[4], 10);
        ...
        data = { DishID, DishName, UnitPrice, QuantityAvailable, Description };
        popup.style.display = 'none';
...
async function loadDishes() {
    ...
    dishes.forEach((dish) => dishContent.innerHTML += createDishComponent(dish))
}
    ...
    return `<div class="general-txt">
                <img src="${verifyImage}" alt="">
                    ...
                    <div class="prices">
                        ...
                        <button class="btn-2" onclick="showEditPopUp('${dish["DishName"]}',${dish["UnitPrice"]},${dish["QuantityAvailable"]},'${dish["Description"] === null ? "" : dish["Description"]}', '${dish["DishID"]}')">Editar</button>
                    </div>
            </div>`;
}
